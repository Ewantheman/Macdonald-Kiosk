...
public class KioskManager {
    ...
    private void greet() {
        System.out.println("Welcome to Mcdonald. Please make your order by pressing the number that corresponds to your choice");
    }
    ...
    private void HandleOrder() {
        ...
        System.out.println();
        System.out.println("Sweet, " + userChoiceOfAmount + " " + userChoiceOfFood.getName() + " has been added to the cart");
        System.out.println();
    }
